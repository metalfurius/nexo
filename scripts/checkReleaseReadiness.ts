...
check(versionWorkflow.includes('refs/pull/${pr_number}/merge'), 'Version workflow must target the strict PR merge ref.')
check(versionWorkflow.includes('automation/version-bump-check'), 'Version workflow must create a temporary branch for strict merge-ref CI.')
